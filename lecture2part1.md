...
In this course, we use the Eclipse Integrated Development Environment (IDE) for developing our Java programs, and the Formal Specifications Checker for Java (FSC4J) Eclipse plugin for developing formal specifications for our Java modules. See the [installation instructions](https://btj.github.io/modular-programming/installing_eclipse.html) online.
